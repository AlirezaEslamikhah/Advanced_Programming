...
namespace LoggerTest
{
    ...
    public class PrivacyScrubberTest 
    {
        ...
        public void IDTest2()
        {
            string testString = "Ali's SSN is  002-463614-2";
        ...
        {
            string piiNum = "8767-3030-5279-4522";
            string scrubbedPII = "XXXX-XXXX-XXXX-XXXX";
            string replacedPIINum = CCScrubber.Instance.Scrub(piiNum);
            Assert.AreEqual(replacedPIINum, scrubbedPII);
        }
